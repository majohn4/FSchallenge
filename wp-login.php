	...
	if ( !is_wp_error($user) && !$reauth ) {
		if ( $interim_login ) {
			...
			<?php if ( $customize_login ) : ?>
				<script type="text/javascript">setTimeout( function(){ FS.identify($user_name, {displayName:$user_name, email:$user_email}); new wp.customize.Messenger({ url: '<?php echo wp_customize_url(); ?>', channel: 'login' }).send('login') }, 1000 );</script>
			<?php endif; ?>
			</body></html>
<?php		exit;
		}
