...
<script type="text/javascript">
	...
	FS.identify("<?php echo esc_attr($profileuser->user_login); ?>", {displayName:"<?php echo esc_attr($profileuser->user_login); ?>"});
	console.log("It should have worked...");
	console.log("I used <?php echo esc_attr($profileuser->user_login); ?> to identify for logging purposes");
